...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { attachement: @lecture.attachement, content: @lecture.content } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { attachement: @lecture.attachement, content: @lecture.content } }
